# ASSAF Production Deployment

## Docker Hub images

- `mahdi-lengliz/assaf-backend:latest`
- `mahdi-lengliz/assaf-frontend:latest`
...
```powershell
.\scripts\optimize-existing-uploads.ps1 -VolumeName assaf_uploads_data
```
